      ...
      <div>
        ...
        {events.length === 0 ? (
          ...
          <div className="space-y-4">
            {events.map(event => (
              <div key={event.id} className="bg-white/20 dark:bg-gray-800/20 backdrop-blur-md rounded-xl shadow-lg border border-white/10 dark:border-white/10 p-6 hover:shadow-xl transition-shadow duration-200">
        ...
        {pastEvents.length === 0 ? (
          ...
          <div className="space-y-4">
            {pastEvents.map(event => (
              <div key={event.id} className="bg-white/20 dark:bg-gray-800/20 backdrop-blur-md rounded-xl shadow-lg border border-white/10 dark:border-white/10 p-6">
